...
function f1() {
   ...
   let resut = document.querySelector('.out-1');

   if (a == 4) {
      resut.innerHTML = 'true';
   } else {
      resut.innerHTML = 'false';
   }
}
...
function f3() {
   let input_1 = document.querySelector('.i-31').value;
   let input_2 = document.querySelector('.i-32').value;

   let result = document.querySelector('.out-3');

   if (input_1 < input_2) {
      result.innerHTML = input_1;
   } else {
      result.innerHTML = input_2;
   }
}
...
function f4() {
   let input_1 = document.querySelector('.i-4').value;
   let age = 2023;
   let result = document.querySelector('.out-4');

   if (age - input_1 < 18) {
      result.innerHTML = 'we not face controle';
   } else {
      result.innerHTML = 'welcome to home';
   }
}
...
function f5() {
   let input_1 = document.querySelector('.i-5').value;
   let result = document.querySelector('.out-5');
...
function f6() {
   let input_1 = document.querySelector('.i-6').value;
...
function f7() {
   let input_1 = +document.querySelector('.i-71').value;
   let input_2 = +document.querySelector('.i-72').value;

   let result = document.querySelector('.out-7').innerHTML = Math.pow(input_1, input_2);
...
function f8() {
   let input_1 = +document.querySelector('.s-8').value;
   let result = document.querySelector('.out-8');
...
function f9() {
   let input_1 = +document.querySelector('.i-9').value;
   let result = document.querySelector('.out-9');

   if (input_1 >= 1 && input_1 <= 32) {
      result.innerHTML = '1';
   } else if (input_1 >= 33 && input_1 <= 43) {
      result.innerHTML = '2';
   } else if (input_1 >= 44 && input_1 <= 64) {
      result.innerHTML = '3';
   } else {
      result.innerHTML = '0';
   }
...
function f14() {
   let input_1 = +document.querySelector('.i-141').value;
   let input_2 = +document.querySelector('.i-142').value;
   let selt = document.querySelector('.s-143').value;
   let out = document.querySelector('.out-14');

   if (selt === '+') {
      out.innerHTML = input_1 + input_2;
   } else if (selt === '-') {
      out.innerHTML = input_1 - input_2;
   } else if (selt === '*') {
      out.innerHTML = input_1 * input_2;
      ...
      result.innerHTML = 'Саня все хуйня, давай по новой';
   }
