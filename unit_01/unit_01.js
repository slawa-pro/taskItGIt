const inputText = document.getElementById('seachText');
const buttonSeach = document.getElementById('seachButten');

buttonSeach.addEventListener("click" , search)

function search() {
    alert('we want to find this');
}
...
let a = document.querySelector('.out-12').innerHTML = 3.14;;
...
let c = document.querySelector('.out-13').innerHTML = '<img src="https://itgid.info/img/js20/js20_unit_01.png" alt="js">';
...
let out19 = document.querySelector('.out-19' + 'out-19-test');
console.log(out19);
