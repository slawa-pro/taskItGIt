...
function f5() {
    let one = document.querySelector('.out-4').classList.contains('bg-orange');
    document.querySelector('.out-5').innerHTML = one;
}
...
function f6() {
let par = document.querySelectorAll('.p-6').length;
...
function f13() {
    ...
    ret.innerHTML = 'pushMe';
    ret.classList.add('bg-orange');
    ret.onclick = f13_1;
    document.querySelector('.out-13').append(ret);
}
...
push.innerHTML = 14;
push.classList.add('bg-orange');

document.querySelector('.out-14').append(push);
}
...
function f15() {
    let push15 = document.createElement('div');
    push15.textContent = 15;
    push15.classList.add('bg-orange');
    
    document.querySelector('.out-15').before(push15);
...
function f16() {
let push16 = document.createElement('div');
push16.innerHTML = 16;
push16.classList.add('bg-orange');

document.querySelector('.out-16').after(push16)
}
...
function f17() {
    let push17 = document.createElement('div');
    push17.innerHTML = 17;
    push17.classList.add('bg-orange');
    
    document.querySelector('.out-17').replaceWith(push17);
}
...
function f18() {
    let atb = document.querySelector('.p-18').getAttribute('data-b');
    document.querySelector('.out-18').innerHTML = atb;
}
...
function f19() {
    let out = '';
    let atb = document.querySelectorAll('.p-19');
    
    for (let i = 0; i < atb.length; i++) {
        out += atb[i].getAttribute('data-b') + ' ';
    }
    console.log(atb)
