...
const f4 = () => { 
    ...
    let a1 = s4.has(inp)
    document.querySelector('.out-4').textContent = a1;
}
...
const f5 = () => {
    let a2 = s5.size
    document.querySelector('.out-5').textContent = a2;
 }
