...
function t8() {
    let red = document.querySelector('.i-8').value;
    document.querySelector('.out-8').innerHTML = red;
...
function t9() {
    let her = document.querySelector('.i-9').value;
    document.querySelector('.out-9').innerHTML = her;
    her.value = '';
}
...
function t10() {
    let fer = document.querySelector('.i-10').value;
    document.querySelector('.out-10').innerHTML = fer * 20;
...
function t11() {
    let ger = document.querySelector('.i-11');
    let dsa = +ger.value + 55;
    document.querySelector('.out-11').innerHTML = dsa;
...
function t12() {
    let rey = document.querySelector('.i-12-1').value;
    let ere = document.querySelector('.i-12-2').value;

    document.querySelector('.out-12').innerHTML = ('Hello' + ' ' + rey + ' ' + ere);
}
...
function t16() {
    let a = document.querySelector('.i-16-1');
    let b = document.querySelector('.i-16-2');
...
function t19() {
    ...
    let resualt = parseInt(a) + parseInt(b);
    document.querySelector('.out-19').innerHTML = resualt;
}
